...
print('####################')
print('This is an example of range values for temperature in Luxembourg:')
pop = a_df['Luxembourg_Temperature']
...
a_df.plot.scatter(x='Luxembourg_Precipitation', y='Luxembourg_Temperature', c='DarkBlue')
plt.show()
